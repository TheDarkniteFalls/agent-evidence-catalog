...
refresh and the 2026-08-18 refresh. The 2026-08-18 catalog is sealed to the exact source-review window and link-audit
...
5. `catalog.json` projects 53 snapshot-current records and 53 non-current
...
copies only that projection and its 106 presentable record files to
...
- 50 superseded records, two historical records and one discontinued record
