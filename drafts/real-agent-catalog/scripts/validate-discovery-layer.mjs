...
assert.equal(await treeDigest([path.join(draftRoot, "candidate-registry")]), "8ee7b5110dddbb5ec3defec04e04d15e3b73867e610485b1d7e74de2cf14ee3e", "Completed 55-surface registry changed");
