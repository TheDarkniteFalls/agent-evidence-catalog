...
assert(readiness.includes("Release status: **55-SURFACE, 115-RECORD REFRESH PREPARED; PUBLICATION IS AUTHORIZED ONLY FOR THE EXACT CANDIDATE AFTER FRESH INDEPENDENT ACCEPTANCE AND ALL RELEASE GATES PASS**"));
assert(readiness.includes("Codex CLI 0.148.0 current record | PASS"));
