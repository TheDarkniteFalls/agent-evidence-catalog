...
const receipt = {
  schemaVersion: "research-preview-browser-qa/1.3",
  asOf: "2026-08-21",
  checkedAt,
  loopback: {
  ...
  publicationAuthorQa: {
    workstream: "AEC-COMPARISON-CONCEPT-FIDELITY-LIVE-BASE-2026-08-22-BROWSER-QA",
    result: "PASS",
    checkedAt,
    baseHead: "576f472e0848907dc916e161b793af53c255f3d4",
    browser: "Codex in-app Browser",
    currentness: {
      records: 123,
      currentRecords: 53,
  ...
  console: { errors: 0, warnings: 0 },
  limitations: [
    "The in-app Browser viewport control is recorded separately from the observed CSS viewport because this session applied a 0.75 device scale; 390 CSS pixels was quantized between measured widths of 389 and 391, so the gate used the conservative 391 by 844 viewport and also measured 320 by 700 exactly.",
