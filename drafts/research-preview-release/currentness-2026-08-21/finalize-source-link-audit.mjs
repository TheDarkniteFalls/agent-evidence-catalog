...
assert.equal(audit.counts.recordsChecked, 123);
...
source.sourceLinkAudit = {
  ...
  method: "HTTP GET with redirects against every unique named official source URL in the projected 123-record corpus",
...
console.log(`PASS bound ${audit.counts.uniqueOfficialUrlsChecked} projected official URLs to the 123-record currentness source (${audit.counts.unreachable} unresolved)`);
