...
const initialReviewedAt = "2026-08-18";
const initialCheckedAt = "2026-08-18T00:00:00.000Z";
...
async function buildSuccessor(predecessor, transition, sourceDigest) {
  ...
  record.sourceDossier = {
    path: "drafts/research-preview-release/currentness-2026-08-18/currentness-source.json",
    sha256: sourceDigest,
  ...
  for (const claim of record.claims) {
    ...
    const relativeRawPath = `drafts/research-preview-release/currentness-2026-08-18/claims/${transition.toRecordId}/${publicSafeFileSlug}.json`;
...
assert(
  (basePreview.asOf === "2026-08-17" && basePreview.counts.recordsPresentedIncludingHistory === priorRecordCount)
    || preparedRerun,
  "Currentness refresh must start from the published 2026-08-17 projection or its own prepared output"
);
...
for (const transition of source.transitions) {
  ...
  const relativeRecordPath = `drafts/research-preview-release/currentness-2026-08-18/records/${transition.toRecordId}.json`;
...
preview.provenance.currentness20260818Path = "drafts/research-preview-release/currentness-2026-08-18/currentness-source.json";
preview.provenance.currentness20260818Sha256 = sourceDigest;
preview.provenance.currentness20260818ReceiptPath = "drafts/research-preview-release/currentness-2026-08-18/currentness-receipt.json";
preview.provenance.currentness20260818OfficialSourceAuditPath = "drafts/research-preview-release/currentness-2026-08-18/official-source-audit.json";
preview.provenance.currentness20260818OfficialSourceAuditSha256 = sha256(surfaceAuditText);
if (prepareOnly) {
  delete preview.provenance.currentness20260818OfficialUrlAuditPath;
  delete preview.provenance.currentness20260818OfficialUrlAuditSha256;
  delete preview.provenance.publicationFreshnessCensusPath;
  delete preview.provenance.publicationFreshnessCensusSha256;
} else {
  preview.provenance.currentness20260818OfficialUrlAuditPath = "drafts/research-preview-release/currentness-2026-08-18/official-url-audit.json";
  preview.provenance.currentness20260818OfficialUrlAuditSha256 = sha256(urlAuditText);
  preview.provenance.publicationFreshnessCensusPath = "drafts/research-preview-release/currentness-2026-08-18/publication-freshness-census.json";
...
const receipt = {
  ...
  officialSurfaceAudit: {
    path: "drafts/research-preview-release/currentness-2026-08-18/official-source-audit.json",
