...
const seal = await readJson("drafts/research-preview-release/currentness-2026-08-20/snapshot-seal.json");
const census = await readJson("drafts/research-preview-release/currentness-2026-08-20/publication-freshness-census.json");
const surfaceAuditText = await read("drafts/research-preview-release/currentness-2026-08-20/official-source-audit.json");
const surfaceAudit = JSON.parse(surfaceAuditText);
const urlAuditText = await read("drafts/research-preview-release/currentness-2026-08-20/official-url-audit.json");
...
const receipt = {
  ...
  snapshot: {
    ...
    bannerCopy: "Catalog snapshot: 20 August 2026, 07:59 UTC. Agent releases change quickly; records with known updates are marked.",
    cacheBustingVersion: "2026-08-20-sealed-snapshot"
  },
  publicationAuthorQa: {
    workstream: "AEC-REFRESH-2026-08-20-AUTHOR",
    result: "PASS",
    checkedAt,
    baseHead: "9897aae13a2cd2d70c856f25d0781ba5586b0d60",
    browser: "Codex in-app Browser",
    currentness: {
      records: 115,
      currentRecords: 53,
  ...
  journeys: {
    ...
    comparison: {
      result: "PASS",
      representativePair: ["com.anthropic.claude-code.cli.2-1-237", "com.openai.codex.cli.0-148-0"],
