...
- `drafts/research-preview-release/currentness-2026-08-21/` — the latest prepared all-surface refresh workflow, eight additive exact-identity successors, 47 retained surface decisions, preferred-source and full-corpus URL receipts, exact snapshot seal, one-shot publication freshness census and dated currentness receipt.
